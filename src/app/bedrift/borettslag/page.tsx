...
export const metadata = createMeta({
  ...
  description: 'Komplett guide til fellesvaskerier med betalingslosninger, maskinvalg og vedlikehold.',
  path: 'bedrift/borettslag',
})

const faqItems = [{"question": "Hvor mange maskiner trenger borettslaget?", "answer": "En maskin per 15 til 20 leiligheter er tommelregelen. Et borettslag med 60 leiligheter trenger 3 til 4 maskiner pluss torketromler."}, {"question": "Leie eller kjope vaskemaskiner?", "answer": "Leasing over 5 til 7 aar med service inkludert er oftest mest loennssomt for borettslag. Maanedlig kostnad er 5 000 til 10 000 kr for et komplett vaskeri."}, {"question": "Hva er en god vaskepris for beboerne?", "answer": "20 til 40 kr per vask dekker strom, vann, vaskemiddel og service. Med digital betaling administreres dette automatisk."}, {"question": "Hvordan velge leverandor til fellesvaskeri?", "answer": "Innhent 3 tilbud, sammenlign totalkostnad over 10 aar, og sjekk referanser fra andre borettslag."}]

export default function Page() {
  const sections = [
    { id: 's0', label: 'Krav til fellesvaskerimaskiner' },
    { id: 's1', label: 'Betalingslosninger for fellesvaskeri' },
        ...
        <div className="lg:grid lg:grid-cols-[1fr_280px] lg:gap-10">
          <div className="min-w-0">
            ...
            <section data-section-id="s0" className="scroll-mt-20 mb-10">
              ...
              <p>Maskiner i fellesvaskerier utsettes for langt hardere bruk enn husholdningsmaskiner. Beboerne har ulik erfaring og vaner, og maskinene kjores mange ganger daglig av forskjellige brukere. Profesjonelle maskiner fra Miele, Electrolux eller Podab er bygget for denne bruken med forsterket konstruksjon, enkle betjeningspaneler og lang levetid.</p>
              <p>Husholdningsmaskiner i fellesvaskerier varer typisk 2 til 4 aar, mens profesjonelle maskiner holder 15 til 20 aar med riktig vedlikehold. Den hoeyere innkjopsprisen betaler seg mange ganger tilbake i form av lavere utskiftningskostnader og faerre driftsstopp.</p>
              <p>Velg maskiner med vanskeliggjort misbruk: laasbare vaskemiddelskuffer, automatisk dosering, og programmer som ikke kan endres av brukeren. Dette forhindrer skader og sikrer at maskinene brukes riktig.</p>
            </section>
            <section data-section-id="s1" className="scroll-mt-20 mb-10">
              <h2>Betalingslosninger for fellesvaskeri</h2>
              <p>Moderne fellesvaskerier bruker digitale betalingslosninger som gjor administrasjonen enkel: Miele AppWash lar beboerne betale og booke via mobilappen. Electrolux Pay per Use gir automatisk avregning. Podab SmartWash tilbyr kort og appbetaling. Priser settes typisk til 20 til 40 kr per vask.</p>
              <p>Digitale losninger eliminerer behovet for myntsystemer og fysiske noekkeler. Styret faar oversikt over bruk, inntekter og maskinenes status i sanntid. Eventuelle feil rapporteres automatisk til serviceleverandoren.</p>
              <p>Inntektene fra vaskeribetaling dekker vanligvis strom, vann, vaskemiddel og serviceavtale. Med riktig prissetting kan fellesvaskeriet gaae i null eller generere et lite overskudd til vedlikeholdsfondet.</p>
            </section>
            <section data-section-id="s2" className="scroll-mt-20 mb-10">
              <h2>Kapasitetsplanlegging</h2>
              <p>En maskin per 15 til 20 leiligheter er tommelregelen. Et borettslag med 60 leiligheter trenger 3 til 4 maskiner pluss tilsvarende antall torketromler. Planlegg med buffer for service slik at minst en maskin alltid er tilgjengelig.</p>
              <p>Vurder ogsaa torkeskap for oemfintlige klær og arbeidstoy. Et torkeskap tar liten plass og er svært populaert blant beboerne. Strykejernstasjon og bretteflate er andre fasiliteter som oker beboertilfredsheten.</p>
            </section>
            <section data-section-id="s3" className="scroll-mt-20 mb-10">
              <h2>Vedlikehold og service</h2>
              <p>Serviceavtale koster 3 000 til 8 000 kr per maskin per aar og inkluderer forebyggende vedlikehold 2 til 4 ganger per aar. Ved driftsstopp gir avtalen prioritert utrykning, vanligvis innen 24 til 48 timer.</p>
              <p>Renhold er beboernes ansvar. Heng opp klare instruksjoner for bruk og rengjoring av lofilt og vaskemiddelskuff. Maskiner med selvrengjorende programmer gjor vedlikeholdet enklere.</p>
            </section>
            <section data-section-id="s4" className="scroll-mt-20 mb-10">
              <h2>Investering og finansiering</h2>
              <p>Komplett vaskeri med 4 maskiner og 4 tromler koster 400 000 til 800 000 kr. Leasing over 5 til 7 aar med service inkludert er den vanligste finansieringsmodellen for borettslag. Maanedlig kostnad blir typisk 5 000 til 10 000 kr.</p>
              <p>Styret bor innhente minst 3 tilbud og sammenligne totalkostnad over 10 aar inkludert service, reservedeler og eventuelle oppgraderinger. Referanser fra andre borettslag er verdifulle for aa vurdere leverandorens palitelighet og responstid.</p>
            </section>
            </div>
            ...
            <div className="overflow-x-auto rounded-2xl border border-slate-200 my-8">
              <table className="w-full text-sm">
                <thead><tr className="bg-slate-800 text-white">
                  <th className="px-4 py-3 text-left font-semibold">Losning</th>
...
<tr className="bg-slate-50"><td className="px-4 py-3 text-slate-700 border-t border-slate-100">Torkeskap Podab FlexDry</td><td className="px-4 py-3 text-slate-700 border-t border-slate-100">8 plagg</td><td className="px-4 py-3 text-slate-700 border-t border-slate-100">Inkludert</td><td className="px-4 py-3 text-slate-700 border-t border-slate-100">25 000 til 40 000 kr</td></tr>
                </tbody>
              </table>
            </div>
            {faqItems.length > 0 && (
        ...
        <div className="container-site py-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <Link href="/bedrift/leverandorer/podab/" className="bg-white rounded-2xl border border-slate-200 p-6 hover:shadow-md hover:border-aqua-300 transition-all group">
                ...
                <p className="text-sm text-slate-600">Spesialist paa fellesvaskerier.</p>
              </Link>
