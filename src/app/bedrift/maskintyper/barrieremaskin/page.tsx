...
const faqItems = [{"question": "Må alle helseinstitusjoner ha barrieremaskin?", "answer": "Sykehus ja. Sykehjem og andre helseinstitusjoner følger lokale krav, men barrierevasking anbefales sterkt."}, {"question": "Hva koster en barrieremaskin?", "answer": "Fra 200 000 kr for 14 kg til over 1 million kr for 100+ kg modeller."}]

export default function Page() {
  const sections = [
    { id: 's0', label: 'Hva er en barrieremaskin' },
    { id: 's1', label: 'Hvor er barrieremaskin påkrevd' },
    ...
    <>
      ...
      <section className="relative bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 text-white overflow-hidden">
        ...
        <div className="container-site py-16 md:py-24 relative z-10">
          ...
          <p className="text-lg text-slate-300 max-w-3xl leading-relaxed">En barrieremaskin er en vaskemaskin med to sider separert av en vegg, der skittent tøy lastes inn fra uren sone og rent tøy tas ut på ren side.</p>
        </div>
      </section>
        ...
        <div className="lg:grid lg:grid-cols-[1fr_280px] lg:gap-10">
          <div className="min-w-0">
            ...
            <section data-section-id="s0" className="scroll-mt-20 mb-10">
              ...
              <p>En barrieremaskin er en spesialkonstruert vaskemaskin som er bygget inn i en vegg mellom to soner: en uren side der kontaminerte tekstiler lastes inn, og en ren side der ferdigvaskede tekstiler tas ut. Veggen mellom sonene eliminerer all risiko for kryssmitte mellom rent og urent. Maskinen har separate dører på hver side som aldri kan åpnes samtidig.</p>
            </section>
            <section data-section-id="s1" className="scroll-mt-20 mb-10">
              <h2>Hvor er barrieremaskin påkrevd</h2>
              <p>Barrieremaskin er påkrevd i sykehus, sykehjem og de fleste helseinstitusjoner i Norge i henhold til Forskrift om smittevern i helsetjenesten. Noen kommuner krever det også i større barnehager og institusjoner for funksjonshemmede.</p>
            </section>
            ...
            <section data-section-id="s3" className="scroll-mt-20 mb-10">
              ...
              <p>Maskinen må monteres i en vegg med riktig tykkelse og styrke. Rørene for vann, avløp, damp og kjemikalier må installeres på begge sider. Gulvet må tåle vekten som kan være opptil 2000 kg for store modeller. Ventilasjon må planlegges for begge soner.</p>
            </section>
            ...
            <div className="overflow-x-auto rounded-2xl border border-slate-200 my-8">
              <table className="w-full text-sm">
                <thead><tr className="bg-slate-800 text-white">
                  <th className="px-4 py-3 text-left font-semibold">Modell</th><th className="px-4 py-3 text-left font-semibold">Kapasitet</th><th className="px-4 py-3 text-left font-semibold">Leverandør</th><th className="px-4 py-3 text-left font-semibold">Ca. pris</th>
                </tr></thead>
                <tbody>
