        ...
        <div className="lg:grid lg:grid-cols-[1fr_280px] lg:gap-10">
          <div className="min-w-0">
            ...
            <section data-section-id="s0" className="scroll-mt-20 mb-10">
              ...
              <p>Tekstilene lastes inn i den ene enden og flyttes automatisk gjennom 8 til 16 kammere: forblotlegging, alkalisk vask, hovedvask med kjemikalier, flere skyllerunder og oppvridning. Hver batch bruker 2 til 4 minutter per kammer. Systemet er kontinuerlig slik at ny batch lastes mens de andre behandles.</p>
            </section>
            ...
            <div className="overflow-x-auto rounded-2xl border border-slate-200 my-8">
              <table className="w-full text-sm">
                <thead><tr className="bg-slate-800 text-white">
                  <th className="px-4 py-3 text-left font-semibold">System</th><th className="px-4 py-3 text-left font-semibold">Gjennomstromning</th><th className="px-4 py-3 text-left font-semibold">Kammere</th><th className="px-4 py-3 text-left font-semibold">Ca. pris</th>
                </tr></thead>
                <tbody>
