...
export const metadata = createMeta({
  title: 'Jensen Group | Verdensledende paa tunnelsystemer | vaskemaskin.no',
  description: 'Alt om Jensen Group tunnelvaskemaskiner og storskala vaskerilosninger.',
    ...
    <>
      ...
      <section className="relative bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 text-white overflow-hidden">
        ...
        <div className="container-site py-16 md:py-24 relative z-10">
          ...
          <h1 className="font-serif text-3xl sm:text-4xl lg:text-5xl font-bold leading-tight mb-6 text-white">Jensen Group | Verdensledende paa tunnelsystemer</h1>
          <p className="text-lg text-slate-300 max-w-3xl leading-relaxed">Jensen Group er verdensledende paa tunnelvaskemaskiner og komplette vaskerilosninger for de storste vaskerioperasjonene.</p>
        </div>
      </section>
        ...
        <div className="lg:grid lg:grid-cols-[1fr_280px] lg:gap-10">
          <div className="min-w-0">
            ...
            <section data-section-id="s0" className="scroll-mt-20 mb-10">
              ...
              <p>Jensen Group ble grunnlagt i 1937 i Danmark og er verdens ledende produsent av tunnelyaskemaskiner og automatiserte vaskerilosninger. Selskapet leverer komplette systemer fra vask til folding for de storste vaskerioperasjonene i verden.</p>
            </section>
            <section data-section-id="s1" className="scroll-mt-20 mb-10">
              <h2>Tunnelsystemer</h2>
              <p>Jensen Senking serien er bransjens referanse for tunnelvaskemaskiner med kapasiteter fra 500 til over 5000 kg per time. Systemene er modulaere og kan skaleres etter behov.</p>
            </section>
            <section data-section-id="s2" className="scroll-mt-20 mb-10">
              <h2>Tilleggsutstyr</h2>
              <p>Jensen leverer ogsaa foldermaskiner, strykeruller, sorteringssystemer, transportbaand og komplett automasjon for vaskerier. Systemene kan integreres med RFID sporbarhet og sentralstyring.</p>
            </section>
          ...
          <PageSidebar sections={sections} relatedLinks={[{ href: "/bedrift/vaskeri/", label: "Vaskeri" }, { href: "/bedrift/maskintyper/tunnelmaskin/", label: "Tunnelmaskin" }, { href: "/bedrift/sykehus/", label: "Sykehus" }]} ctaTitle="Tilbake til oversikt" ctaText="Se alle bedriftslosninger." ctaLink="/bedrift/" ctaLinkText="Bedriftsoversikt" />
        </div>
      </div>
    </>
  )
