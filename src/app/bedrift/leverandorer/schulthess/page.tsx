    ...
    <>
      ...
      <section className="relative bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 text-white overflow-hidden">
        ...
        <div className="container-site py-16 md:py-24 relative z-10">
          ...
          <p className="text-lg text-slate-300 max-w-3xl leading-relaxed">Schulthess er et sveitsisk premiummerke kjent for enestaaende byggekvalitet og innovative losninger for profesjonell vask.</p>
        </div>
      </section>
        ...
        <div className="lg:grid lg:grid-cols-[1fr_280px] lg:gap-10">
          <div className="min-w-0">
            ...
            <section data-section-id="s0" className="scroll-mt-20 mb-10">
              <h2>Om Schulthess</h2>
              <p>Schulthess ble grunnlagt i 1845 i Zuerich og er et av de eldste navnene i vaskemaskinbransjen. Merket er kjent for sveitsisk presisjon og holdbarhet. Spesielt sterkt paa borettslag, hotell og maritime losninger.</p>
            </section>
            <section data-section-id="s1" className="scroll-mt-20 mb-10">
              <h2>Styrker</h2>
              <p>Eksepsjonell byggekvalitet. Svært lavt stoeynivaa. Gode losninger for fellesvaskerier med SmartConnect systemet. Maritime serien for offshore og skipsfart.</p>
            </section>
          ...
          <PageSidebar sections={sections} relatedLinks={[{ href: "/bedrift/borettslag/", label: "Borettslag" }, { href: "/bedrift/offshore/", label: "Offshore" }, { href: "/bedrift/prisguide/", label: "Prisguide" }]} ctaTitle="Tilbake til oversikt" ctaText="Se alle bedriftslosninger." ctaLink="/bedrift/" ctaLinkText="Bedriftsoversikt" />
        </div>
      </div>
    </>
  )
