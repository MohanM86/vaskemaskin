        ...
        <div className="lg:grid lg:grid-cols-[1fr_280px] lg:gap-10">
          <div className="min-w-0">
            ...
            <section data-section-id="s0" className="scroll-mt-20 mb-10">
              <h2>Om Primus</h2>
              <p>Primus tilhører Alliance Laundry Systems som er verdens største produsent av kommersielle vaskemaskiner. Primus er spesielt sterkt på myntvaskerier og fellesvaskerier med robuste maskiner og avanserte betalingssystemer.</p>
            </section>
