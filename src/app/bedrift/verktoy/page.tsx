...
export const metadata = createMeta({
  ...
  path: 'bedrift/verktøy',
})

const tools = [
  { href: '/bedrift/verktøy/vaskeri-roi/', icon: IconTrendingUp, title: 'Vaskeri ROI kalkulator', desc: 'Beregn lønnsomheten av eget vaskeri vs. outsourcing. Se breakeven punkt, årlig besparelse og totalkostnad over tid.', cta: 'Beregn ROI' },
  { href: '/bedrift/verktøy/kapasitetsplanlegger/', icon: IconTarget, title: 'Kapasitetsplanlegger', desc: 'Legg inn bransje, antall enheter og vaskebehov. Få anbefalt antall maskiner, kapasitet og estimert investering.', cta: 'Planlegg kapasitet' },
    ...
    <div className="container-site py-10">
      <div className="lg:grid lg:grid-cols-[1fr_280px] lg:gap-10">
        <div className="min-w-0">
          ...
          <div data-section-id="verktøy" className="scroll-mt-20 grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {tools.map((tool, i) => (
        ...
        <PageSidebar sections={sections} relatedLinks={[
          ...
          { href: '/verktøy/', label: 'Verktøy for forbrukere' },
        ]} />
      </div>
    </div>
  )
