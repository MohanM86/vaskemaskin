    ...
    <>
      <section className="relative bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 text-white overflow-hidden">
        ...
        <div className="container-site py-16 md:py-24 relative z-10">
          <Breadcrumbs items={[{ label: 'Hjem', href: '/' }, { label: 'Bedrift', href: '/bedrift/' }, { label: 'Kapasitetsplanlegger' }]} />
<p className="text-lg text-slate-300 max-w-3xl leading-relaxed">Finn riktig antall maskiner for din virksomhet</p>
        </div>
      </section>
