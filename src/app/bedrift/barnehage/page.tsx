...
const faqItems = [{"question": "Må barnehager ha profesjonelle maskiner?", "answer": "Kommunale barnehager har krav om profesjonelle maskiner i driftsavtalene. Private barnehager bør følge samme retningslinjer for å sikre hygienisk vask og lang levetid."}, {"question": "Hvor ofte vaskes sengetøy i barnehagen?", "answer": "Ukentlig på minimum 60 grader. Ved sykdomsutbrudd vaskes alt umiddelbart på 85 grader eller med desinfiserende vaskemiddel."}, {"question": "Hva koster det å kjøpe vaskemaskin til barnehage?", "answer": "En profesjonell maskin på 8 kg koster 25 000 til 55 000 kr. Leasing med service er tilgjengelig fra 800 til 1 500 kr per måned."}, {"question": "Hvilken maskin er best for barnehage?", "answer": "Miele PW 5082 og Electrolux myPRO er de mest populære valgene. Begge har allergiprogrammer og kompakte mål som passer små vaskerom."}]
    ...
    <>
      ...
      <section className="relative bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 text-white overflow-hidden">
        ...
        <div className="container-site py-16 md:py-24 relative z-10">
          ...
          <p className="text-lg text-slate-300 max-w-3xl leading-relaxed">Barnehager vasker alt fra sengetøy til skitne klær. Gode vaskemaskiner er en forutsetning for god hygiene og redusert sykefravær.</p>
        </div>
      </section>
        ...
        <div className="lg:grid lg:grid-cols-[1fr_280px] lg:gap-10">
          <div className="min-w-0">
            ...
            <section data-section-id="s0" className="scroll-mt-20 mb-10">
              ...
              <p>En typisk barnehage med 4 avdelinger vasker 15 til 30 kg tekstiler per dag: sengetøy fra soveavdelingene, kluter og håndklær fra kjøkken og bad, samt skiftetøy og laken. I perioder med mye sykdom kan volumet øke betydelig.</p>
              <p>Profesjonelle maskiner har dessuten kortere syklustider og lavere driftskostnader per vask enn husholdningsmaskiner. En profesjonell maskin varer typisk 15 til 20 år mot 8 til 10 år for en forbrukermodell, noe som gjør totaløkonomien bedre.</p>
            </section>
            <section data-section-id="s1" className="scroll-mt-20 mb-10">
              ...
              <p>Bruk alltid parfymefrie og allergimerkede vaskemidler. Automatisk doseringssystem sikrer riktig mengde og forhindrer overdosering som kan irritere sensitiv hud. Miele og Electrolux tilbyr begge spesialprogrammer for allergivennlig vask som er testet og sertifisert.</p>
            </section>
            <section data-section-id="s2" className="scroll-mt-20 mb-10">
              <h2>Smittevern og hygiene</h2>
              <p>Sengetøy vaskes ved minimum 60 grader ukentlig. Ved utbrudd av omgangssyke, hånd, fot og munn eller andre smittsomme sykdommer anbefaler FHI vask ved 85 grader eller bruk av desinfiserende vaskemiddel. Kluter fra stell og kjøkken bør vaskes daglig ved 60 grader.</p>
              <p>Husk at vask ved 40 grader ikke dreper bakterier effektivt. Selv om lavtemperaturvask sparer energi, er det ikke egnet for barnehager der smittevern er avgjørende. Profesjonelle maskiner med dokumenterte vaskeprogrammer gjør det enkelt å bevise at hygienekravene er oppfylt.</p>
            </section>
            <section data-section-id="s3" className="scroll-mt-20 mb-10">
              ...
              <p>Plasser maskinen nær avdelingene for å minimere transport av skittentøy. Sørg for god ventilasjon i vaskerommet for å unngå fukt og muggproblemer. Gulvet bør ha sluk og være vanntett.</p>
            </section>
            <section data-section-id="s4" className="scroll-mt-20 mb-10">
              <h2>Driftskostnader og budsjett</h2>
              <p>Strøm og vann koster 3 til 6 kr per vask. Årskostnad inkludert vaskemiddel og service ligger på 15 000 til 25 000 kr for en typisk barnehage. En profesjonell maskin på 8 kg koster 25 000 til 55 000 kr avhengig av merke og funksjoner.</p>
              <p>Serviceavtale anbefales og koster typisk 2 000 til 5 000 kr per år. Denne dekker forebyggende vedlikehold og gir prioritert respons ved feil. De fleste leverandører tilbyr leasing med service inkludert fra 800 til 1 500 kr per måned.</p>
            </section>
            </div>
