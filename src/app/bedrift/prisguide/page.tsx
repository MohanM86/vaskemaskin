...
export const metadata = createMeta({
  ...
  description: 'Komplett prisoversikt for profesjonelle vaskemaskiner. Fra små 6 kg maskiner til industrielle tunnelsystemer.',
...
export default function Page() {
  const sections = [
    { id: 's0', label: 'Priser for små profesjonelle maskiner (6 til 10 kg)' },
    ...
    { id: 's5', label: 'Priser for tørkeskap' },
        ...
        <div className="lg:grid lg:grid-cols-[1fr_280px] lg:gap-10">
          <div className="min-w-0">
            ...
            <section data-section-id="s1" className="scroll-mt-20 mb-10">
              ...
              <p>Mellomstore profesjonelle maskiner koster 50 000 til 150 000 kr. Electrolux Line 6000 serien ligger på 45 000 til 120 000 kr og har det bredeste utvalget. Miele Performance serien koster 70 000 til 150 000 kr. Primus FX serien er et godt prisalternativ på 50 000 til 100 000 kr. Disse passer for hoteller, større barnehager og institusjoner.</p>
            </section>
            ...
            <section data-section-id="s5" className="scroll-mt-20 mb-10">
              ...
              <p>Tørkeskap koster 20 000 til 50 000 kr avhengig av kapasitet og produsent. Podab FlexDry er det mest populære valget i Skandinavia. Nimo ECO Dryer med varmepumpe er noe dyrere men mer energieffektivt.</p>
            </section>
