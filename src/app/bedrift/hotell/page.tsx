...
const faqItems = [{"question": "Hvor mange maskiner trenger et hotell med 100 rom?", "answer": "Et hotell med 100 rom genererer ca. 600 kg tekstiler per dag. Med 8 timers drift trenger du typisk 3 til 5 maskiner på 20 til 32 kg, eller en tunnelmaskin for større volumer."}, {"question": "Lønner eget vaskeri seg for hoteller?", "answer": "For hoteller med mer enn 50 rom lønner eget vaskeri seg vanligvis innen 2 til 4 år. Kostnaden per kilo reduseres fra 12 til 25 kr ved outsourcing til 4 til 8 kr med eget vaskeri."}, {"question": "Hvilken temperatur maa hotellstoytoy vaskes paa?", "answer": "Sengetøy og håndklær skal vaskes ved minimum 60 grader. Svanemerket hoteller har tilleggskrav til energi og vaskemidler."}, {"question": "Hva koster det aa etablere hotellvaskeri?", "answer": "Et komplett vaskeri for et mellomstort hotell koster 500 000 til 2 millioner kr inkludert maskiner, tørketromler og installasjon."}]
        ...
        <div className="lg:grid lg:grid-cols-[1fr_280px] lg:gap-10">
          <div className="min-w-0">
            ...
            <section data-section-id="s1" className="scroll-mt-20 mb-10">
              ...
              <p>For hotellkjeder med flere eiendommer i samme by kan det lønner seg aa etablere et sentralvaskeri. Et sentralvaskeri med tunnelmaskin kan betjene 3 til 5 hoteller og redusere kostnad per kilo med 30 til 50 prosent sammenlignet med individuelle vaskerier.</p>
            </section>
            <section data-section-id="s2" className="scroll-mt-20 mb-10">
              ...
              <p>Hoteller med mer enn 150 rom bor vurdere tunnelvaskemaskin. En tunnelmaskin kan håndtere opptil 5000 kg per time med kontinuerlig drift. Investeringen er hoy, typisk 1,5 til 5 millioner kroner, men kostnaden per kilo faller dramatisk til 3 til 5 kroner.</p>
              <p>Tørketromler bor dimensjoneres med 20 til 30 prosent større kapasitet enn vaskemaskinene fordi torking tar lengre tid enn vask. Flatwork ironers for sengetøy og duker er en lønnsomm investering for hoteller med mer enn 50 rom.</p>
            </section>
            <section data-section-id="s3" className="scroll-mt-20 mb-10">
              ...
              <p>En mellomløsning er aa vaske hverdagstekstiler som håndklær og sengetøy internt, mens spesialprodukter som uniformer, gardiner og tepper outsources. Dette gir lavere investering og reduserer personalbehov.</p>
            </section>
            <section data-section-id="s4" className="scroll-mt-20 mb-10">
              <h2>Hygienekrav for hotellvaskeri</h2>
              <p>Mattilsynets veileder krever at sengetøy og håndklær vaskes ved minimum 60 grader for aa sikre hygienisk rent resultat. For Svanemerket hoteller stilles tilleggskrav til vannforbruk per kilo, energieffektivitet og bruk av miljomerkede vaskemidler.</p>
              <p>Allergikere utgjor en voksende gjestesegment. Maskiner med ekstra skylleprogram og bruk av parfymefrie vaskemidler på allergirom er et konkurransefortrinn. NS INSTA 800 standarden definerer renhetsnivåer og kan brukes som kvalitetsmål.</p>
            </section>
            </div>
