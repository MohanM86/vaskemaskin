    ...
    <>
      ...
      <section className="relative bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 text-white overflow-hidden">
        ...
        <div className="container-site py-16 md:py-24 relative z-10">
          ...
          <h1 className="font-serif text-3xl sm:text-4xl lg:text-5xl font-bold leading-tight text-white mb-3">Feilkoder på vaskemaskiner</h1>
          <p className="text-lg text-slate-300 max-w-3xl leading-relaxed mb-4">{totalCodes} feilkoder fra {errorBrands.length} merker. Velg ditt merke for å finne ut hva koden betyr.</p>
        </div>
      </section>
