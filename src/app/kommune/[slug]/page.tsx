    ...
    <>
      ...
      <section className="relative bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 text-white overflow-hidden">
        ...
        <div className="container-site py-16 md:py-24 relative z-10">
          ...
          <h1 className="font-serif text-3xl sm:text-4xl lg:text-5xl font-bold leading-tight text-white mb-3">Hvitevarebutikker i {kommune.name}</h1>
          <p className="text-lg text-slate-300 max-w-3xl leading-relaxed mb-8">{stores.length} butikker som selger vaskemaskiner i {kommune.name}, {fylke?.name}.</p>
        </div>
      </section>
