...
export const manuals: BrandManual[] = [
  ...
  },
  {
    ...
    sections: [
      { heading: 'De viktigste programmene', content: 'Grundig vaskemaskiner har et oversiktlig programvalg med bomull 60 og 40 grader for hverdagstøy, syntetisk for polyester og blandingsstoffer, finvask for ømfintlige plagg, og et hurtigprogram på fjorten minutter for lett tilsmussede plagg. FiberCare programmet bruker skånsom trommelbevegelse for å beskytte tekstilfibre. Eco programmet gir lavest mulig strømforbruk med lengre vasketid. Ullprogrammet vasker ved tretti grader med minimal trommelbevegelse.' },
